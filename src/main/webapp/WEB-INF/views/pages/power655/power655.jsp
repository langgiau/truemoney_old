                    ...
                    <div class="panel-body" style="position: relative">
                        ...
                        <div class="form-group">
                            <div class="form-row">
                                ...
                                <div class="col">
                                    <label for="power655Kymua">Kỳ quay</label>
                                    <select onchange="power655SelectKymuaChange();" id="power655Kymua" multiple="multiple" placeholder="Chọn kỳ" class="form-control input-sm">                                        
                                    </select>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            <div class="power655Circle text-right">
                                <strong>Tạm tính :</strong> <strong style="color: red"><span id="power655CountAllMoney">0</span>đ</strong>
                            </div>
                        </div>
                        <div class="form-group">
                            <button type="button" onclick="power655BtnToChonnhanh();" class="btn btn-warning btn-block btn-md">CHỌN NHANH</button>
                        </div>
                        <div>
                            <div class="form-row">
                                <div class="col">
                                    <button type="button" onclick="power655BtnAddBasket();" class="btn btn-primary btn-block btn-md">THÊM VÀO GIỎ</button>
                                </div>
                                <div class="col">
                                    <button type="button" onclick="power655BtnBuyNow();" class="btn btn-danger btn-block btn-md">XEM GIỎ HÀNG</button>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            ...
                            <h4 class="modal-title"><span id="power655ModelNumberTitle" style="padding-right: 10px; color: #ffe003; font-weight: bold;"></span> Chọn số</h4>
                        </div>
                        ...
                        <div class="modal-footer">
                            <div class="text-center" style="padding: 0 15px 15px 15px">
                                <button onclick="power655ModalBtnChonsoSubmit();" type="button" class="btn btn-danger btn-md btn-block">Đồng ý</button>
                            </div>
                        </div>
                    </div>
                </div>
